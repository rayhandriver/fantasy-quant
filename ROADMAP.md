...
value + rookie model~~ ✅ → now (3) **Phase 5 — the per-player distribution** for the risk dial (user chose
the **full** 5.1–5.5 stack, incl. injury survival + utility; wraps the 4.2 value-board contract); then (4)
