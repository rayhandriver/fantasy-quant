...
- **★ ← NOW: the mining program (Sessions M-0 … M-6) is UNBLOCKED but still UNSCOPED**, and **M-1** now
  ...
  window) and **Sessions MM-1 · MM-2** (fitted manager model, 16.18). The user's call which comes first.
